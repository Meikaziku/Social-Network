...
<body class="bg-[#AFBFC0] min-h-screen flex flex-col">
    ...
    <main class="flex-1 flex items-center justify-center w-full ">
          ...
          <form class="bg-white flex flex-col items-center py-16 font-[Roboto] gap-3" action="" method="post">

          <label class="text-2xl font-medium " for="username">Connectez vous</label>
          <input class="w-1/2 rounded-sm text-center border-[0.1px]" type="text" id="username" name="username" placeholder="Entrez votre nom d'utilisateur" required>
